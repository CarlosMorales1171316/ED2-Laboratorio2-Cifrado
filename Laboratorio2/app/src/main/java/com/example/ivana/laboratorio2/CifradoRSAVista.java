...
public class CifradoRSAVista extends AppCompatActivity {

    Button Cifrar,Ruta,Escogerkey1,Escogerkey2,Descifrar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Descifrar.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Borrar();
                Intent intent = new Intent(CifradoRSAVista.this, DescifrarRSAVista.class);
    ...
    {
        if(ContextCompat.checkSelfPermission(CifradoRSAVista.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED)
        {
            if(ActivityCompat.shouldShowRequestPermissionRationale(CifradoRSAVista.this,Manifest.permission.WRITE_EXTERNAL_STORAGE))
            {
                //Explicacion permiso
            }
            else
            {
                ActivityCompat.requestPermissions(CifradoRSAVista.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},MY_PERMISSION_REQUEST_WRITE_EXTERNAL);
            }
        }
    }
    private void CheckPermission2()
    {
        if(ContextCompat.checkSelfPermission(CifradoRSAVista.this, Manifest.permission.READ_EXTERNAL_STORAGE)!=PackageManager.PERMISSION_GRANTED)
        {
            if(ActivityCompat.shouldShowRequestPermissionRationale(CifradoRSAVista.this,Manifest.permission.READ_EXTERNAL_STORAGE))
            {
                //Explicacion permiso
            }
            else
            {
                ActivityCompat.requestPermissions(CifradoRSAVista.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},MY_PERMISSION_REQUEST_READ_EXTERNAL);
            }
        }
    }
